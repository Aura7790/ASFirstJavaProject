public class Main2 {
    public static void main(String[] args) {
        ...
        String myName = "Aura";
        System.out.println(LogicalOperations.printMyGreeting(greeting, myName));
        ...
        int b = 8;
        int c = 6;
        System.out.println(LogicalOperations.doOperationA(a, b, c));

        // b. (55+9) % 9
        int d = 55;
        int e = 9;
        System.out.println(LogicalOperations.doOperationB(d, e));

        //c. 20 + -3*5 / 8
        int f = 20;
        int g = -3;
        System.out.println(LogicalOperations.doOperationC(f, g, y, b));

        //d. 5 + 15 / 3 * 2 - 8 % 3
        int i = 15;
        int j = 3;
        int k = 2;
        System.out.println(LogicalOperations.doOperationD(y, i, j, k, b, j));
    }
}
